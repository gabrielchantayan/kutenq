...
/**
 * Normalize a number by padding it
 * @param {Float} num 
...
/**
 * Check if text is filled out. Returns false if empty or undefined
...
export { deepMerge, camelize, normalizeFraction, getProperty, stringToBool, getDotEnv, zeroPad, isTextFilledOut }